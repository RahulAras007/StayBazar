...
{
    public class PartialPaymentListForMail
    {
        private const string URL_PARTIALPAYMENT = "PartialPaymentLink";
        private const string URL_PARTIALPAYMENT_LIST = "PartialPaymentBookingList";
        ...
        public void Start()
        {
            ...
            string url = ConfigurationManager.AppSettings.Get(URL_PARTIALPAYMENT_LIST);
            string urlbody = ConfigurationManager.AppSettings.Get(URL_PARTIALPAYMENT);
            ...
            mailMsg.Subject = "Reminder: Payment pending";
