...
#region HELPER_FUNCTIONS
        ...
        public static void AppendTextCell(string cellReference, string cellStringValue, Row excelRow)
        {
        ...
        public static void AppendNumericCell(string cellReference, string cellStringValue, Row excelRow)
        {
            //  Add a new Excel Cell to our Row 
