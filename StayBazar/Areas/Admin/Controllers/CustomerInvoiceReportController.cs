...
{
    public class CustomerInvoiceReportController : Controller
    {
        public const int LIMIT = 500;
        // GET: Admin/CustomerInvoiceReport
        public ActionResult Index()
        {
          ...
          //  DateTime FromDate = DateTime.Now.AddDays(-30);
            ...
            string SearchString = "";
            List<CLayer.OfflineBooking> users = BLayer.OfflineBooking.CustomerInvoiceReport(SearchString,LIMIT, curdate, ToDate);
        ...
        public ActionResult ExcelReport(CLayer.OfflineBooking model)
        {
            ...
            string ToDatesonlyDate = DateTime.Parse(ToDates).ToShortDateString();
            Reportlist    = BLayer.OfflineBooking.CustomerInvoiceReport(SearchString, LIMIT, FromDate, ToDate);
            ...
            Response.Charset = "";
            return View("~/Areas/Admin/Views/CustomerInvoiceReport/Excel.cshtml", data.OfflineBookingList);
        }
    }
}