...
{
    public class BankUploadReportController : Controller
    {
        ...
        public ActionResult Index()
        {
          ...
          //  curdate = DateTime.Now;
            ...
            string SearchString = "";
            List<CLayer.OfflineBooking> users = BLayer.OfflineBooking.BankUploadReport(SearchString, LIMIT, curdate, ToDate);
        ...
        public ActionResult PDFView(Models.OfflineBookingModel model)
        {
            ...
            DateTime FromDate = Convert.ToDateTime(date1);
            DateTime ToDate = Convert.ToDateTime(date2);
            List<CLayer.OfflineBooking> data = BLayer.OfflineBooking.BankUploadReport(SearchString, LIMIT, FromDate, ToDate);
        ...
        public ActionResult ExcelReport(CLayer.OfflineBooking model)
        {
            ...
            try
            {
                ...
                string ToDatesonlyDate = DateTime.Parse(ToDates).ToShortDateString();
                Reportlist = BLayer.OfflineBooking.BankUploadReport(SearchString, LIMIT, FromDate, ToDate);
            ...
            Response.Charset = "";
            return View("~/Areas/Admin/Views/BankUploadReport/Excel.cshtml", data.OfflineBookingList);
        }
