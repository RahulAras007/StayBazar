...
namespace StayBazar.Areas.Admin.Controllers
{
    ...
    public class TransactionsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            List<CLayer.Booking> users = BLayer.Transaction.GetAllForSearch((int)CLayer.ObjectStatus.BookingStatus.CheckOut, "", 1, 0, 25);
            search.SearchString = "";
        ...
        public ActionResult Pager(Models.TransactionsModel data)
        {
            ...
            {
                users = BLayer.Transaction.GetAllForSearchWithType((int)CLayer.ObjectStatus.BookingStatus.CheckOut,data.InventoryAPIType, data.SearchString, data.SearchValue, (data.currentPage - 1) * data.Limit, data.Limit);

            }
            else
            {
                users = BLayer.Transaction.GetAllForSearch((int)CLayer.ObjectStatus.BookingStatus.CheckOut, data.SearchString, data.SearchValue, (data.currentPage - 1) * data.Limit, data.Limit);
            ...
            #region GDS Booking Cancel
                ...
                if (InventoryAPIType == (int)CLayer.ObjectStatus.InventoryAPIType.Amadeus)
                {
                   String  ControlNumber = BLayer.Bookings.GetGDSBookingControlNumber(BookingId);
                    ...
                    string resultCancel =StayBazar.Common.APIUtility.ExecutePNRCancel(ControlNumber, OptionCode);
                }
            #endregion 
                //ViewBag.Saved = true;
        ...
        public async Task<bool> BookingConfirm(long bookingId)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (forUser[0].Email != byUser.Email)
                    {
                        customerMsg.CC.Add(byUser.Email);
                    }
                    ...
                    //send email and sms to supplier
