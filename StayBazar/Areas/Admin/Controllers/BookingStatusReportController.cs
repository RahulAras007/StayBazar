...
namespace StayBazar.Areas.Admin.Controllers
{
    ...
    public class BookingStatusReportController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            if (data.FromDate >= Convert.ToDateTime("01/06/2017 00:00:00") && data.ToDate >= Convert.ToDateTime("01/06/2017 00:00:00"))
            {
                ...
                data.BookingStatusReportList = BLayer.Report.BookingStatusReportGST(data.FromDate, data.ToDate, 0, 2000, LoginUserid);
            }
            else
            {
        ...
        public ActionResult Filter(Models.BookingStatusReportModel data)
        {
            ...
            if (data.FromDate >= Convert.ToDateTime("01/06/2017 00:00:00") && data.ToDate >= Convert.ToDateTime("01/06/2017 00:00:00"))
            {
                Reportlist = BLayer.Report.BookingStatusReportGST(data.FromDate, data.ToDate, 0, 2000, LoginUserid);
            }
            else
            {
        ...
        public ActionResult Pager(Models.BookingStatusReportModel data)
        {
            ...
            if (data.FromDate >= Convert.ToDateTime("01/06/2017 00:00:00") && data.ToDate >= Convert.ToDateTime("01/06/2017 00:00:00"))
            {
                Reportlist = BLayer.Report.BookingStatusReportGST(data.FromDate, data.ToDate, (data.currentPage - 1) * data.Limit, data.Limit, LoginUserid);
            }
            else
            {
