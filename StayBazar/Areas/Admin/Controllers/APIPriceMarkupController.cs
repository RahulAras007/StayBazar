...
{
    public class APIPriceMarkupController : Controller
    {
        //#region Custom Methods
        //private Models.APIPriceMarkupModel InitialData()
        //{
        //    Models.APIPriceMarkupModel data = new Models.APIPriceMarkupModel();
        //    data.API = BLayer.APIPriceMarkup.GetAPIPriceMarkup();
        //    return data;
        //}
        //#endregion
        ...
        public ActionResult SaveDetails(Models.APIUserModel data)
        {
            try
            {
                CLayer.APIPriceMarkup API = new CLayer.APIPriceMarkup();
                {
                    ...
                    API.DescriptionId   = data.DescriptionId;
                    API.CustomerId  = data.CustomerId;
                    API.SellMarkup  = data.SellPrice;

                };
                BLayer.APIPriceMarkup.Save(API);
