...
namespace StayBazar.Areas.Admin.Controllers
{
    ...
    {
        //
        // GET: /Admin/RegularUser/
        //[Common.AdminRolePermission(AllowAllRoles=true)]
        [Common.AdminRolePermission]
        public ActionResult Index()
        {
            Models.UserSearchModel search = new Models.UserSearchModel();
            List<CLayer.User> users = BLayer.User.GetAllCustomerForSearch((int)CLayer.ObjectStatus.StatusType.Active, "", 1, (int)CLayer.Role.Roles.Customer, 0, 25);
        ...
        public ActionResult Filter(Models.UserSearchModel data)
        {
            ...
            List<CLayer.User> users = BLayer.User.GetAllCustomerForSearch(data.Status, data.SearchString, data.SearchValue, (int)CLayer.Role.Roles.Customer, 0, 25);
        ...
        {
            if (data.SearchString == null) data.SearchString = "";
            List<CLayer.User> users = BLayer.User.GetAllCustomerForSearch(data.Status, data.SearchString, data.SearchValue, (int)CLayer.Role.Roles.Customer, (data.currentPage - 1) * data.Limit, data.Limit);
            ViewBag.Filter = new Models.UserSearchModel();
            Models.UserSearchModel forPager = new Models.UserSearchModel()
            {
                Status = data.Status,
