...
{
    public class OfflineSupplierPaymentReportController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            string SearchString = "";
            List<CLayer.OfflineBooking> users = BLayer.OfflineBooking.offlinePaymentReport(SearchString, LIMIT, curdate, ToDate);
        ...
        public ActionResult PDFView(Models.OfflineBookingModel model)
        {
            ...
            DateTime FromDate = Convert.ToDateTime(date1);
            DateTime ToDate = Convert.ToDateTime(date2);
            List<CLayer.OfflineBooking> data = BLayer.OfflineBooking.offlinePaymentReport(SearchString, LIMIT, FromDate, ToDate);
        ...
        public ActionResult ExcelReport(CLayer.OfflineBooking model)
        {
            ...
            try
            {
                ...
                string ToDatesonlyDate = DateTime.Parse(ToDates).ToShortDateString();
                Reportlist = BLayer.OfflineBooking.offlinePaymentReport(SearchString, LIMIT, FromDate, ToDate);
            ...
            Response.Charset = "";
            return View("~/Areas/Admin/Views/offlineSupplierPaymentReport/Excel.cshtml", data.OfflineBookingList);
        }
    }
}