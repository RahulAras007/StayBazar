...
{
    public class CorporateCreditBookingsController : Controller
    {
        ...
        public ActionResult Pager(Models.CreditBookingModel data)
        {
            ...
            List<CLayer.Booking> users = BLayer.Transaction.GetAllCorporateCreditBookingsForSearch(data.Status, data.SearchString, data.SearchValue, (data.currentPage - 1) * data.Limit, data.Limit);
        ...
        public ActionResult MarkAsPayment(long BId, Models.CreditBookingModel data)
        {
            ...
            List<CLayer.Booking> users = BLayer.Transaction.GetAllCorporateCreditBookingsForSearch((int)CLayer.ObjectStatus.Corpcreditbookstatus.Paid, "", 0, 0, 25);
            ViewBag.Filter = new Models.CreditBookingModel();
            Models.CreditBookingModel forPager = new Models.CreditBookingModel()
            {
                Status = data.Status,
