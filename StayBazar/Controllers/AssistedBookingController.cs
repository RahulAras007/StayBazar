...
{
    public class AssistedBookingController : Controller
    {
            ...
            try
            {
                ...
                if (id != 0)
                {
                    ...
                    if (usr != null)
                    {
                        ...
                        cm.AssistedBooking_Flag = usr.AssistedBookingFlag;
        ...
        public ActionResult SetAssistedBooking_FlagifChecked(long id)
        {
            try
            {
                BLayer.B2BUser.SetAssistedFlagIfChecked(id);
                return View("_List");
            }
            catch (Exception ex)
            {
        ...
        public ActionResult SetAssistedBooking_FlagifUnChecked(long id)
        {
            try
            {
                BLayer.B2BUser.SetAssistedFlagIfUnChecked(id);
                return View("_List");
            }
            catch (Exception ex)
            {
